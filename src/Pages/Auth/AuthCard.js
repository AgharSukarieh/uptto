...
const AuthCard = ({
  ...
  const handleVerifyLoginOtp = async () => {
    ...
    try {
      ...
      // إذا كان هناك صفحة مطلوبة، ارجع إليها، وإلا اذهب إلى dashboard
  ...
  const handleLoginSubmit = async (event) => {
    ...
    try {
      ...
      // توجيه الأدمن إلى صفحة الأدمن، والمستخدمين العاديين إلى dashboard أو الصفحة المطلوبة
      const from = location.state?.from || null;
      if (isAdmin) {
        navigate("/admin/dashboard", { replace: true });
      } else {
                ...
                <form id="signupForm" className="login-form" onSubmit={handleSignupSubmit}>
                  ...
                  <div className="form-row-inline">
                    <div className="form-group half-width">
                      <label htmlFor="signup-country">اختر الدولة</label>
                      <select
                        id="signup-country"
                        value={signupCountry}
                    ...
                    <div className="form-group half-width">
                      <label htmlFor="signup-university">اختر الجامعة</label>
                      <select
                      ...
                      >
                        <option value="">
                          {isLoadingUniversities ? "جارٍ تحميل الجامعات..." : "اختر الجامعة"}
                        </option>
